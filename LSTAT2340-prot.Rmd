...
```{r ms1s, results='markup', fig.margin=FALSE, fig.cap="MS1 spectra (blue) over retention time (left). MS2 spectra (pink) interleaved between two MS1 spectra (right),", echo=FALSE, fig.fullwidth=TRUE}
...
**Statistical challenge** The matching between millions of observed
  ...
  space and the risk of false positives. See [@Kall:2008] for futher
  reading.
```
